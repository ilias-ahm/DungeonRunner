...
DungeonRunnerSFML::AIPlayer::AIPlayer(std::vector<std::shared_ptr<DungeonRunner::Entity>>& gameEntities,
...
void DungeonRunnerSFML::AIPlayer::display() { gWindow->draw(aiPlayer); }
