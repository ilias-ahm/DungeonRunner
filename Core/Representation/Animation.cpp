...
DungeonRunnerSFML::Animation::Animation(const std::shared_ptr<sf::Texture>& aniTexture, const sf::Vector2u& imageCount)
...
sf::IntRect DungeonRunnerSFML::Animation::getUvRect() { return uvRect; }
